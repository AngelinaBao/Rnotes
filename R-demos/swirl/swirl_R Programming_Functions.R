...
remainder(5)
remainder(11, 5)
# When you explicitly designate argument values by name, the ordering of the arguments 
# becomes unimportant.
remainder(divisor = 11, num = 5)
# R can also partially match arguments
remainder(4, div = 2)
#you may be wondering if there is a way you can see a function's arguments 
#(besides looking at the documentation). Thankfully, you can use the args() function!
args(remainder)
